  ...
  return (
    <div className={signupStyles.pageContainer}>
      ...
      <div className={signupStyles.animatedBackground.base}>
        <div className={`${signupStyles.animatedBackground.orb1} ${isActive ? 'translate-x-10 sm:translate-x-20 translate-y-5 sm:translate-y-10' : ''}`}></div>
        <div className={`${signupStyles.animatedBackground.orb2} ${isActive ? '-translate-x-10 sm:-translate-x-20 -translate-y-5 sm:-translate-y-10' : ''}`}></div>
        <div className={`${signupStyles.animatedBackground.orb3} ${isActive ? '-translate-x-5 sm:-translate-x-10 translate-y-10 sm:translate-y-20' : ''}`}></div>
      </div>
      ...
      <div className={`${signupStyles.signupCard.container} ${isActive ? 'scale-100 opacity-100' : 'scale-90 opacity-0'}`}>
        ...
        >
            ...
            <div className="flex items-start mt-2 sm:mt-3 md:mt-4">
              ...
              <div className="ml-2 sm:ml-3 text-xs sm:text-sm">
                <label htmlFor="terms" className={signupStyles.form.checkboxLabel}>
                  I agree to the <span className={signupStyles.form.checkboxLink}>Terms & Conditions</span>
                </label>
              </div>
            </div>
          ...
          {/* Signin Section */}
          <div className={signupStyles.signinSection} style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
