...
//                 <FaMapMarkerAlt className={styles.infoIcon} /> Our Information
//               </h2>
...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Form Submitted:', formData); // later connect backend / email service
        ...
        <div className={styles.cardContainer}>
          ...
          <div className={styles.infoCard}>
            <div className="relative z-10 space-y-5">
              ...
              <div className={styles.infoItemContainer}>
                {[
                  { icon: FaWhatsapp, label: 'WhatsApp', value: '+91 9791903195' },
                  { icon: FaEnvelope, label: 'Email', value: 'aparnaapar99@gmail.com' },
                  { icon: FaClock, label: 'Hours', value: 'Mon-Sat: 8AM-8PM' },
                ].map((info, i) => (
                  <div key={i} className={styles.infoItem}>
                    <div className={styles.iconContainer('bg-orange-900/30')}>
                      <info.icon className="text-orange-400 text-lg" />
                    </div>
                    <div>
                      <h3 className={styles.infoLabel}>{info.label}</h3>
                      <p className={styles.infoValue}>
            ...
            {!isSubmitted ? (
                      ...
                      return (
                        <div key={field} className={styles.inputContainer}>
                          ...
                          {field !== 'carType' ? (
                            ...
                            >
                              <option value="">Select Car Type</option>
                              {['Economy', 'SUV', 'Luxury', 'Van', 'Sports Car', 'Convertible'].map(
                                (opt) => (
              ...
              <div className="flex flex-col items-center justify-center text-center py-16 animate-fadeIn">
                ...
                <button
                  ...
                  className="mt-6 px-6 py-2 rounded-lg bg-orange-600 hover:bg-orange-700 transition text-white"
                >
